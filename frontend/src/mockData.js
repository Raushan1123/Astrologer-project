...
// Note: Image URLs are optimized for performance (WebP format, compressed)
...
export const mockServices = [
  ...
  },
  {
    ...
    icon: "Briefcase",
    image: "https://images.unsplash.com/photo-1729335511883-29eade10006b?w=800&q=80&fm=webp&fit=crop&auto=format",
    duration: "30 mins",
    actualPrice: 3500,
    discountPercent: 25,
    markup: 20  // 20% markup applied to final price
  },
  {
    ...
    icon: "Heart",
    image: "https://images.unsplash.com/photo-1600429991827-5224817554f8?w=800&q=80&fm=webp&fit=crop&auto=format",
    duration: "45 mins",
    actualPrice: 5100,
    discountPercent: 25,
    markup: 20  // 20% markup applied to final price
  ...
  },
  {
    ...
    icon: "Home",
    image: "https://images.unsplash.com/photo-1729335511904-9b8690184935?w=800&q=80&fm=webp&fit=crop&auto=format",
    duration: "20-30 mins",
    actualPrice: 3000,
    discountPercent: 25,
    markup: 20  // 20% markup applied to final price
  },
  {
    ...
    icon: "Hand",
    image: "https://images.unsplash.com/photo-1758926384162-b3783d5fa09e?w=800&q=80&fm=webp&fit=crop&auto=format",
    duration: "15 mins",
    actualPrice: 2000,
    discountPercent: 25,
    markup: 20  // 20% markup applied to final price
...
export const mockBlogs = [
  {
    ...
    image: "https://images.unsplash.com/photo-1515942661900-94b3d1972591?w=600&q=75&fm=webp&fit=crop&auto=format",
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1729335511904-9b8690184935?w=600&q=75&fm=webp&fit=crop&auto=format",
    author: "Acharyaa Indira Pandey",
    date: "2024-12-01",
...
export const mockFAQs = [
  ...
  },
  {
    ...
    answer: "Absolutely. I maintain complete confidentiality for all clients. Your personal information and consultation details are kept private and secure."
  },
  {
    id: "3",
    question: "How should I prepare before the session?",
    answer: "Please have your accurate birth details ready: date, time, and place of birth. Prepare specific questions you'd like to address. An open mind helps in receiving guidance effectively."
  },
  {
    id: "4",
    question: "What is the consultation fee?",
    answer: "Consultation fees depend on the client's requirements and type of service. Pricing varies accordingly. Please contact me for a detailed quotation based on your needs."
  },
  {
    id: "5",
    question: "Do you offer online consultations?",
    answer: "Yes, I offer both online and in-person consultations. Online sessions are conducted via video call, making it convenient for clients from anywhere."
  }
];
...
export const astrologers = [
  {
    ...
    image: "https://images.unsplash.com/photo-1554355202-11fbc45c7157?w=400&q=80&fm=webp&fit=crop&auto=format",
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&q=80&fm=webp&fit=crop&auto=format",
